...
public class PromptRepository {
    public HashMap<LocalDate, Prompt> getAllPrompts(){
        ...
        prompts.put(date, new Prompt(1, date, "Spring Boot is fun!"));
        prompts.put(date.minusDays(1), new Prompt(2, date.minusDays(1), "I love cupcakes"));
        prompts.put(date.minusDays(2), new Prompt(3, date.minusDays(2), "Captain America dies"));
        prompts.put(date.minusDays(3), new Prompt(4, date.minusDays(3), "I'm keeping the xmas lights up"));
        prompts.put(date.minusDays(4), new Prompt(5, date.minusDays(4), "I need a job"));
